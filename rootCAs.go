...
// source: https://github.com/TheThingsArchive/go-utils/blob/master/roots/cert_pool.go
const mozillaRootCAs = `
-----BEGIN CERTIFICATE-----
...
func init() {
	...
	rootCAs.AppendCertsFromPEM([]byte(comodoRootCA))
	rootCAs.AppendCertsFromPEM([]byte(mozillaRootCAs))
}
